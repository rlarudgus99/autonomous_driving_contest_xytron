...
class LaneDetector():
    ...
    def __init__(self):
        ...
        self.bev = BEV()
        self.bev.warp_img_mid = self.bev.warp_img_mid + 50
    ...
    def predict_lane(self):
        ...
        '''
        predicted_lane = self.lane[1] + [-200/max(np.cos(self.angle), 0.75), 0, 180/max(np.cos(self.angle), 0.75)]
